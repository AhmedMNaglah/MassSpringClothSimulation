...
private:
	...
	void	MidPointIntegrate( float DeltaTime,  bool ErrorAnalys);
	void	HeunIntegrate( float DeltaTime , int HuenIter, bool ErrorAnalys);
	void	EulerIntegrate( float DeltaTime, bool ErrorAnalys);
